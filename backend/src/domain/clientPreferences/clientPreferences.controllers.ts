...
export const getMyDietaryRestrictions = async (
  req: AuthRequest,
  res: Response,
): Promise<void> => {
  try {
    ...
    const restrictions = await ClientPreferencesStore.getDietaryRestrictions(
      clientProfile.id,
    );
...
export const getMyAllergies = async (
  ...
  try {
    ...
    const allergies = await ClientPreferencesStore.getAllergies(
      clientProfile.id,
    );
...
export const addAllergy = async (
  ...
  try {
    ...
    const added = await ClientPreferencesStore.addAllergy(
      clientProfile.id,
      allergy,
    );
...
export const removeAllergy = async (
  ...
  try {
    ...
    await ClientPreferencesStore.removeAllergy(
      clientProfile.id,
      allergy as Allergy,
    );
...
export const getMyFavoriteCuisines = async (
  req: AuthRequest,
  res: Response,
): Promise<void> => {
  try {
    ...
    const cuisines = await ClientPreferencesStore.getFavoriteCuisines(
      clientProfile.id,
    );
...
export const addFavoriteCuisine = async (
  req: AuthRequest,
  res: Response,
): Promise<void> => {
  try {
    ...
    const added = await ClientPreferencesStore.addFavoriteCuisine(
      clientProfile.id,
      cuisine,
    );
...
export const removeFavoriteCuisine = async (
  req: AuthRequest,
  res: Response,
): Promise<void> => {
  try {
    ...
    await ClientPreferencesStore.removeFavoriteCuisine(
      clientProfile.id,
