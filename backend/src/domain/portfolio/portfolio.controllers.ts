...
export const getMyPortfolio = async (
  ...
  try {
    ...
    const portfolioItems =
      await PortfolioStore.getPortfolioItemsByCookProfileId(cookProfile.id);
...
export const getCookPortfolio = async (
  req: AuthRequest,
  res: Response,
): Promise<void> => {
  try {
...
export const createPortfolioItem = async (
  ...
  try {
    ...
    const portfolioItem = await PortfolioStore.createPortfolioItem(
      cookProfile.id,
      itemData,
    );
